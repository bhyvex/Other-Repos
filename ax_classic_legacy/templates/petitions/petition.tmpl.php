...
<?$x=0; foreach($petitions as $petitions=>$v):?>
            <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
              ...
              <td align="center" width="10%"><? echo date("Y M d", $v['senttime']) . "&nbsp;&nbsp;" . date("g:ia", $v['senttime']) ?></td>
              <td align="right"><a href="index.php?editor=petitions&dib=<?=$v['dib']?>&action=2"><img src="images/edit2.gif" border="0" title="View Petition"></a>&nbsp;<a onClick="return confirm('Really Delete Petition <?=$v['dib']?>?');" href="index.php?editor=petitions&dib=<?=$v['dib']?>&action=4"><img src="images/remove3.gif" border="0" title="Delete this petition"></a></td>
            </tr>
<?$x++; endforeach;?>
<?endif;?>
<?if (!isset($petitions)):?>
