  ...
  <div class="table_container" style="width: 600px;">
    <div class="table_header">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left">Server Economy (Decoded on 12/11/2017)</td>
        </tr>
      </table>
    </div>
          ...
          <td class="edit_form_content">
            <fieldset>
              ...
              <table class="edit_form_content" width="100%">
                ...
                <tr>
				  <td align="center" width="25%"><?=$cash2['platinum'];?></td>
				  <td align="center" width="25%"><?=$cash2['gold'];?></td>
				  <td align="center" width="25%"><?=$cash2['silver'];?></td>
                  <td align="center" width="25%"><?=$cash2['copper'];?></td>
...
<div class="table_container" style="width: 600px;">
    <div class="table_header">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left">Server Economy (Archived 9/24/2017)</td>
        </tr>
      </table>
    </div>
    <div class="table_content">
